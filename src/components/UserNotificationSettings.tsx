...
const businessNotifications: NotificationType[] = [
  ...
  },
  {
    ...
    name: 'Vencimiento de Oportunidades',
    description: 'Notificaciones de seguimiento: a los 14 días activa, 7 días antes de vencer, y al vencer.',
    enabled: true,
    email: true,
    push: true,
  },
  {
    id: 'marketplace_view',
    name: 'Vistas en Servicios del Marketplace',
    description: 'Notificaciones cuando alguien vea tus servicios publicados.',
    enabled: true,
    email: true,
    push: true,
  },
  {
    ...
    name: 'Consultas de Servicios',
    description: 'Notificaciones sobre consultas y solicitudes de tus servicios.',
    enabled: true,
    email: true,
    push: true,
  },
