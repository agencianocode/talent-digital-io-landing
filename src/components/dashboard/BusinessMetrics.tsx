        ...
        >
          ...
          >
            <CardContent className="p-3 sm:p-4 text-center">
              ...
              <div className="text-[10px] sm:text-xs md:text-sm text-muted-foreground whitespace-nowrap overflow-hidden text-ellipsis">Postulaciones en Oportunidades Activas</div>
