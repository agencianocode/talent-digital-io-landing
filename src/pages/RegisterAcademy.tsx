...
const RegisterAcademy = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    navigate(`/email-verification-pending?type=academy&email=${encodeURIComponent(formData.email)}`);
    return;
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2">
            Registro para Academias
          </h1>
          <p className="text-muted-foreground">
            Conecta tus estudiantes con oportunidades laborales
          </p>
        </div>

        <Card>
          <CardHeader>
            <CardTitle>Crear cuenta para Academia</CardTitle>
            <CardDescription>
              Completa la información para comenzar a gestionar tu academia
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {message && (
                <Alert>
                  ...
                  <AlertDescription>
                    Verifica tu email para acceder a tu dashboard y comenzar a gestionar estudiantes.
                  </AlertDescription>
                </Alert>
              )}
